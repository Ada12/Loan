...
<div class="col-md-3">
    ...
    <div class="col-md-10 col-md-offset-2">
        <ul id="sidebar" class="nav nav-pills nav-stacked" style="text-align: left">
            ...
            <hr style="padding: 0px;margin: 0px">
            <li class="active" role="presentation"><a href="/EasyLoan/inspection"><span style="color: #ffffff">Project Inspection</span></a></li>
            <hr style="padding: 0px;margin: 0px">
...
<div class="col-md-8" style="padding: 0px;margin: 0px;margin-bottom: 60px">
    ...
    <div class="col-md-12" style="margin-top: 30px">
        <p style="font-size: 20px">Project Inspection</p>
