...
<div id="background" class="col-md-12" style="height: 800px;color: #ffffff">
    <div class="col-md-4 col-md-offset-4" style="text-align: center;margin-top: 60px;padding-right: 30px">
        <img src="/img/logo_black.png" style="width: 100%">
    </div>
    <div class="col-md-4 col-md-offset-4 bg-info" style="background-color: rgba(0, 0, 0, 0.78);margin-top: 20px">
        <div class="col-md-12" style="padding: 30px">
            <span style="font-size: 30px">Login</span>
            <form action="/EasyLoan/login" method="post" style="margin-top: 25px">
                ...
                <button type="submit" class="btn btn-success btn-flat" style="width: 100%;margin-top: 20px;margin-bottom: 15px">Login</button>
                ${error_msg}
                <span style="font-size: 15px"><a href="/EasyLoan/register" style="margin-left: 266px;color: #34c3fa">Register+</a></span>
            </form>
        </div>
    </div>
</div>
