...
<div class="col-md-8" style="padding: 0px;margin: 0px">
    ...
    <div class="col-md-12" style="margin-top: 30px">
        <p style="font-size: 20px">Pending Project</p>
        <hr style="border:0;background-color:#d3d3d3;height:1px">
    </div>

    <div class="col-md-12" style="margin-bottom: 10px">
        <div class="btn-group" role="group" aria-label="...">
            <a href="/EasyLoan/pending" type="button" class="btn btn-default active selectbutton" style="width: 80px">Pending</a>
            <a href="/EasyLoan/received" type="button" class="btn btn-default selectbutton" style="width: 80px">Received</a>
        </div>
    </div>
